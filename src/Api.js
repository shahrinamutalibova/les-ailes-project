          ...
          return (
            ...
            <Card className='card' >
              <div style={{width:"100%",display:"flex",justifyContent:"center",alignItems:"end",height:"180px"}}>
                ...
                <h2 style={{color:"#FC004A"}}>{item.price}</h2>   
          ...
          { buttons[item.id] ? ( 
                    <div style={{display:"flex",gap:"120px"}}>
                      <button 
                        ...
                        style={{background:"#FC004A",cursor:"pointer",marginTop:"5px",color:"white",width:"30px",height:"30px",border:"none",borderRadius:"50%"}}
                      > 
                        + 
                      </button>
                    </div>
                    ...
                    <button 
                      onClick={() => handleButtonClick(item.id)}  
                      style={{background:"#F8AA00",cursor:"pointer",marginTop:"5px",color:"white",width:"30px",height:"30px",border:"none",borderRadius:"50%"}}
                    > 
                      - 
                    </button>
                    <button 
       ...
       <Row gutter={[10,10]} style={{padding:"30px 50px"}}>
        {items.map((item, index) => {
          ...
          <button 
            ...
            style={{background:"#",cursor:"pointer",marginTop:"5px",color:"white",width:"30px",height:"30px",border:"none",borderRadius:"50%"}}
          > 
            + 
          </button>
          <button 
